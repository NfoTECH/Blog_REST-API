...
class UserServiceImplTest {
    ...
    void setUp() {
        ...
        user = new User(1L, "Uzonna" , "uzo@gmail.com" , "user" , "1234" , localDateTime , localDateTime  , postList , commentList , likeList);
        post = new Post(2L, "Test my blog" , "Test the endpoints of my blog" , "test-my-blog" , "blog.png", localDateTime , localDateTime , user, commentList , likeList);
    ...
    @Test
    void register() {
        UserDto userDTO = new UserDto( "Thelma" ,"thelma@gmail.com" , "user" , "1234");
        ...
        actual.getUser().setId(5L);
        assertEquals(registerResponse , actual);
    }

    @Test
    void login_Success() {
        LoginDto loginDto = new LoginDto("fortune@gmail.com" , "perp");
    ...
    @Test
    void createPost() {
        when(userRepository.findById(4L)).thenReturn(Optional.ofNullable(user));
        PostDto postDto = new PostDto( "Test my blog" , "Test the endpoints of my blog" , "blog.png", 4L);
